package com.lksim.drone.dancer.examples;
...
//                Thread(target=self._ramp_motors).start()
        ...
        mCrazyflie.sendPacket(new CommanderPacket(0, 0, 0, (char) 15000));
    ...
    public static void main(String[] args) {
        ...
        if (foundCrazyflies != null && foundCrazyflies.size() > 0) {
            new MotorRampExample(foundCrazyflies.get(0));
        }
